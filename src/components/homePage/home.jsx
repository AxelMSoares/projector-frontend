                ...
                <div className="background">
                    <div className="content-wrapper">
                        ...
                        <div className="desc-text">
                            ...
                            <p className="description"><span>Envie de participer? </span> Bientôt on integrera une fonction qui vous permettra de postuler à un projet public et de proposer des tâches et solutions. Vous pourrez ainsi aider d'autres personnes à avancer dans leur projet.</p>
                        </div>
                    </div>
                </div>
            </main>
